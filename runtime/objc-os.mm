...
**********************************************************************/
// note: objc 启动入口，dyld -> libSystem.B.dylib`libSystem_initializer -> libdispatch.dylib`libdispatch_init -> libdispatch.dylib`_os_object_init -> libobjc.A.dylib`::_objc_init()
